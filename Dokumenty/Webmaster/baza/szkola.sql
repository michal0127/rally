...
INSERT INTO tbUczniowie VALUES (NULL, 'Michał', 'Rębiś', 0, 1, 99, 100, 98);

INSERT INTO tbUczniowie VALUES (NULL, 'Hubert', 'Gajewski', 0, 1, 100, 100, 100);

UPDATE tbUczniowie SET egzJez = 77 WHERE id = 1;